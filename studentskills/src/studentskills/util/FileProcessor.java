...
public final class FileProcessor {
	...
	public FileProcessor(String inputFilePath)
		...
		MyLogger.writeMessage("Inside File Processor", MyLogger.DebugLevel.FILE_PROCESSOR);
		MyLogger.writeMessage("Inside File Processor Constructor", MyLogger.DebugLevel.CONSTRUCTOR);
